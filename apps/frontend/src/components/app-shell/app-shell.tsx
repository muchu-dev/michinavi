...
export function AppShell({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-dvh bg-app-canvas md:px-6 md:py-5">
      ...
      <div className="relative mx-auto flex min-h-dvh w-full max-w-[30rem] flex-col overflow-hidden bg-surface shadow-app md:min-h-[calc(100dvh-2.5rem)] md:rounded-[2rem] md:border md:border-outline">
