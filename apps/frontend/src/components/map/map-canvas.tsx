...
export function MapCanvas({
  ...
  const controlledPosition: [number, number] | null = currentLocation
    ...
    : showDemoLocation
      ? center
      : null;
  const displayedLocation = controlledPosition ?? requestedPosition;
  ...
  function requestCurrentPosition() {
    ...
    navigator.geolocation.getCurrentPosition(
      ({ coords }) => {
        setRequestedPosition([coords.latitude, coords.longitude]);
  ...
  return (
    <>
      ...
      >
        ...
        {displayedLocation ? (
          <>
            <MoveMapToCurrentPosition position={displayedLocation} />
            <CircleMarker
