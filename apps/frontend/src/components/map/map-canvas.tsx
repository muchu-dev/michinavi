...
// 千代田区役所・九段南周辺をデモ地図の初期表示位置にする。
const center: [number, number] = [35.6938, 139.753];
    ...
    kind === "flooding"
      ...
      : condition === "passable"
        ...
        : condition === "impassable"
          ...
          : '<path d="M28 18v10"/><circle cx="28" cy="34" r="1.5" fill="white" stroke="none"/>';

  return divIcon({
    className: "bg-transparent border-0",
    html: `<svg aria-label="${getReportLabel(kind, condition)}" role="img" viewBox="0 0 56 68" width="44" height="54" fill="none"><path d="M28 2C13.6 2 2 13.6 2 28c0 18.7 20.4 33.1 24.8 36a2.2 2.2 0 0 0 2.4 0C33.6 61.1 54 46.7 54 28 54 13.6 42.4 2 28 2Z" fill="${color}" stroke="white" stroke-width="3"/><g stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">${symbol}</g></svg>`,
    iconSize: [44, 54],
    iconAnchor: [22, 52],
    popupAnchor: [0, -48],
  });
